...
function drawCharts() {
  ...
  var serviceCategoriesData = new google.visualization.DataTable();
  serviceCategoriesData.addColumn('string', 'Category');
  serviceCategoriesData.addColumn('number', 'Services');
  serviceCategoriesData.addRows([
    [ "Biostatistics", 15 ],
    [ "Genomics", 20 ],
    [ "Phylogeny", 5 ],
    [ "Systems Biology", 26 ],
  ...
  var serviceCategoriesChart = new google.visualization.BarChart(document.getElementById('service_categories_graph_div'));
  serviceCategoriesChart.draw(serviceCategoriesData, {
    width: 750,
    height: 600,
    chartArea: { height:"70%", width: "70%", top: 80 },
